...
//        Cyfry: 48-57
        ...
        char exclamation = '!';
        System.out.println("ASCII '!': " + (int) exclamation);
        char at = '@';
        System.out.println("ASCII '@': " + (int) at);
        char lessThan = '<';
        System.out.println("ASCII '<': " + (int) lessThan);
        char newLine = '\n';
        System.out.println("ASCII '\\n' (newline): " + (int) newLine);
        char backspace = '\b';
        System.out.println("ASCII '\\b' (backspace): " + (int) backspace);
